    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            var $dropdown = this.dropdown,
                ...
                height = container.get(0).getBoundingClientRect().height,
                width = container.get(0).getBoundingClientRect().width,
                dropHeight = $dropdown.get(0).getBoundingClientRect().height,
                $window = $(window),
            ...
            if (changeDirection) {
                ...
                height = this.container.get(0).getBoundingClientRect().height;
        ...
        ensureHighlightVisible: function () {
            ...
            rb = results.offset().top + results.get(0).getBoundingClientRect().height;
            if (hb > rb) {
